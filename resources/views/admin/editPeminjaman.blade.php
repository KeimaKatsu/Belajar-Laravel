...
<body>
    <nav class="navbar navbar-dark bg-primary">
        <div class="container">
            <a class="navbar-brand" href="{{ route('admin.peminjaman') }}">Politeknik Negeri Bengkalis
                    ...
                    <div class="card-body">
                        ...
                        <form action="/postEditPeminjaman/{{ $data->id}}" method="POST">
                            ...
                            <div class="form-group mt-1">
                                ...
                                <input type="text" class="form-control border border-secondary form-control" name="tanggalPeminjaman" required value="{{ $data->tanggal_pinjaman }}">
                                <span class="text-danger">

...
class AdminController extends Controller
{
    ...
    public function postTambahAdmin(Request $request)
    {
        ...
        $request->validate([
            'name' => 'required',
            'email' => 'required|email:dns|unique:users', // Ensure email is unique in the users table
    ...
    public function postTambahBuku(Request $request)
    {
        ...
        $buku->kode_buku = $request->input('kodeBuku');
        $buku->judul_buku = $request->input('judulBuku');
    ...
    public function adminPeminjaman(Request $request, ChartPeminjaman $chartPeminjaman)
    {
        ...
        $chart = $chartPeminjaman->build(); // Inisialisasi objek grafik
    ...
    public function postTambahPeminjaman(Request $request)
    {
        ...
        $peminjaman->tanggal_pinjaman = $request->tanggalPeminjaman;
